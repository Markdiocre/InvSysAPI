    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remarks', models.CharField(choices=[('a', 'Accepted'), ('r', 'Rejected'), ('p', 'Pending')], default='p', max_length=2)),
                ('inventory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='invsys_back.inventory')),
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='invsys_back.product'),
        ),
        migrations.AddField(
            model_name='inventory',
            name='user',
